...
@view_config(route_name='love.express', request_method='GET', renderer='splinter_love:templates/express.mako')
...
@view_config(route_name='love.list', request_method='GET', renderer='splinter_love:templates/list.mako')
